...
This project will help for recommending to uses the top 10 food items based on there recent interest and interactions with application
...
------------
    ...
    │
    ├── models             <- Trained and serialized models, model predictions, or model - (Here you save the model pickle file, its predictions and summaries) summaries
    │
